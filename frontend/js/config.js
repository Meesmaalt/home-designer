...
export const CATALOG = [
  ...
  },
  {
    ...
    items: [
      { id: 'hotTubIntegrated', name: 'Terrassi süvistatud kümblustünn (LED)', icon: '♨️', eur: 2450 },
      { id: 'modernDeckWrap', name: 'Sauna ümbritsev terrassikompleks (L-kuju)', icon: '🪵', eur: 1850 },
      { id: 'modernLounge', name: 'Modernne lounge-diivan & laud', icon: '🛋️', eur: 980 },
      { id: 'modernFireTable', name: 'Minimalistlik betoonist tulelaud', icon: '🔥', eur: 680 },
      { id: 'slatScreenModern', name: 'Termopuidust ribi-tuulesein', icon: '🪵', eur: 320 },
      { id: 'glassBalustrade', name: 'Karastatud klaaspiire terrassile (3m)', icon: '🪟', eur: 450 },
      { id: 'modernPergola', name: 'Must minimalistlik lamellpergola', icon: '🏛️', eur: 2200 },
      { id: 'sunLoungerModern', name: 'Modernne päikesetool polstriga', icon: '⛱️', eur: 280 },
      { id: 'modernBollard', name: 'Must minimalistlik terrassipollar', icon: '💡', eur: 75 },
      { id: 'modernHangingFireplace', name: 'Rippuv ovaalne disainkamin lakke', icon: '🔥', eur: 1450 },
